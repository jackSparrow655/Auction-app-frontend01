...
const CardTwo = ({ imgSrc, title, startingBid, startTime, endTime, id }) => {
  ...
  return (
    <>
      <div className="basis-full py-5 px-3 border bg-richblack-900 rounded-xl group sm:basis-56 lg:basis-60 2xl:basis-80">
        <img
          src={imgSrc}
          alt={title}
          className="w-full rounded-xl aspect-[4/3] m-auto"
        />
        <div className="px-2 pt-4 pb-2">
          ...
          {startingBid && (
            <p className="text-stone-600 text-xl">
              Starting Bid:{" "}
              <span className="text-[#f6eecc] font-bold ml-1">
                {startingBid}
              </span>
            </p>
          )}
          <p className="text-stone-600 ">
            ...
            {Object.keys(timeLeft).length > 1 ? (
              <span className="text-[#ffe6d3] font-bold ml-1">
          ...
          <div className="flex flex-col gap-2 mt-4">
            <Link
              className="text-center font-semibold bg-caribbeangreen-200 text-richblack-800 text-xl px-4 py-2 rounded-xl border"
              to={`/auction/details/${id}`}
            >
              View Auction
            </Link>
            <button
              className=" text-center font-semibold bg-pink-300 text-xl px-4 py-2 rounded-xl border"
            ...
            <button
              ...
              className={`text-center font-semibold bg-[#1a22ff] text-xl px-4 py-2 border rounded-xl`}
            >
              Republish Auction
            </button>
          </div>
