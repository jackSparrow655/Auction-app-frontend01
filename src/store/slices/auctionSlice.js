...
export const republishAuction = (id, data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `${url}/auctionitem/item/republish/${id}`,
      data,
      {
        withCredentials: true,
